...
Robot.prototype._init = function () {
  ...
  this._sendCommand(this.commands.Start);
...
Robot.prototype._sendCommand = function (command) {
  ...
  if (!!this.options.sendcommand) return this.options.sendcommand(this, packetBytes);
...
Robot.prototype.demo = function (demoId) {
  if (!this.commands.Demo) throw new Error('robot does not support Demo command');
  this._sendCommand(this.commands.Demo, demoId.id);
  return this;
};
...
Robot.prototype.dock = function () {
  if (!!this.commands.Demo) this.demo(demos.CoverAndDock); else this._sendCommand(this.commands.ForceSeekingDock);
  return this;
};
